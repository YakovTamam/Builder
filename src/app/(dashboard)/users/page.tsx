    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="rounded-xl border border-zinc-800 bg-zinc-900 overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody>
            {users.map((user) => (
              <tr key={String(user._id)} className="border-b border-zinc-800 last:border-0">
                ...
                <td className="p-3">
                  <span
                    className={
                      user.status === "active"
                        ? "rounded-full bg-emerald-700/30 text-emerald-400 px-2.5 py-1 text-xs"
                        : "rounded-full bg-zinc-700 text-zinc-300 px-2.5 py-1 text-xs"
                    }
                  >
            ...
            {users.length === 0 && (
              <tr>
                <td colSpan={4} className="p-3 text-zinc-400 text-center">

  ...
  return (
    <div className="flex flex-1 flex-col bg-gray-50 text-gray-900">
      <div className="flex flex-1 flex-col items-center justify-center px-6 text-center">
        ...
        <Link
          href="/login"
          className="rounded-lg bg-emerald-600 hover:bg-emerald-500 transition-colors text-white px-6 py-3 font-medium"
        >
          כניסה למערכת
        </Link>
      </div>

      <footer className="flex items-center justify-center gap-2 border-t border-gray-200 py-4 px-6 text-sm text-gray-400">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src={settings.logoUrl}
          alt="Builder"
